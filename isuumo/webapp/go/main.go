...
func searchChairs(c echo.Context) error {
	...
	searchQuery := "SELECT * FROM chair FORCE INDEX (chair_popularity_desc_index) WHERE "
...
func searchEstates(c echo.Context) error {
	...
	searchQuery := "SELECT id, thumbnail, name, description, latitude, longitude, address, rent, door_height, door_width, features, popularity FROM estate FORCE INDEX (estate_popularity_desc_index) WHERE "
...
func searchRecommendedEstateWithChair(c echo.Context) error {
	...
	query = "SELECT id, thumbnail, name, description, latitude, longitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE" +
